...
const LineButton = ({classes, type, hide, color, text, className, ...props}) => (
  hide
  ? null
  : <Button type={type} variant = 'outlined' className={classNames(className, classes.button, classes[color])} {...props}>
    {text}
  </Button>
)
